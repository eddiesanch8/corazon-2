...
const accessories = [
  {
    title: "The Churse",
    description: "A plucky purse from CLT",
    img: "/churse.png",
    id: 1,
  },
  {
    title: "Labubu Chain",
    description: "Not 5 Karat gold",
    img: "/labubu-chain.png",
    id: 2,
  },
  {
    title: "Heart Locket",
    description: "Wear your heart on your... neck?",
    id: 3,
...
export default function CarouselAcc({
  ...
  return (
    <div
      ref={containerRef}
      className={`carousel-container accessories ${round ? "round" : ""}`}
      style={{
        width: `${baseWidth}px`,
